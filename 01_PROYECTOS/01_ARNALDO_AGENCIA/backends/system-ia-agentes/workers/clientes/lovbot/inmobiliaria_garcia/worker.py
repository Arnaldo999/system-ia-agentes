"""
Worker — Inmobiliaria García — Lovbot Inmobiliaria
=================================================
...
NOMBRE_EMPRESA = os.environ.get("INMO_DEMO_NOMBRE",  "Inmobiliaria García")
CIUDAD         = os.environ.get("INMO_DEMO_CIUDAD",  "San Ignacio")
NOMBRE_ASESOR  = os.environ.get("INMO_DEMO_ASESOR",  "Arnaldo")
NUMERO_ASESOR  = os.environ.get("INMO_DEMO_NUMERO_ASESOR", "543765384843")
...
try:
    from workers.clientes.lovbot.inmobiliaria_garcia import db_postgres as db
...
router = APIRouter(prefix="/clientes/lovbot/inmobiliaria-garcia", tags=["Inmobiliaria García"])
...
def _gemini_calificar(sesion: dict) -> dict:
    ...
    # ── CONTEXTO DEL NEGOCIO (inyectado por clonar_worker_lovbot.py) ──
    # NEGOCIO: Inmobiliaria García
    # VERTICAL: inmobiliaria
    # PRODUCTOS/SERVICIOS: Loteo Barrio La Noria (300 lotes), Loteo Privado 8250 lotes)
    # RANGO DE PRECIOS: 30000 a 150000 USD
    # DIFERENCIALES: 15 años de experiencia, financiacion, entrega inmediata
    # OBJECIONES COMUNES: Es muy caro, no tengo tiempo
    # PUBLICO OBJETIVO: Familias
    # ZONAS DE LEADS: San Ignacio, Roca, Apostoles
        # TONO: Formal y profesional. Sin modismos regionales. Tratar de 'usted'. Evitar emojis excepto en saludo.
    # ─────────────────────────────────────────────────────────────────
